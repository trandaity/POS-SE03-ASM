...
<table>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2022 <a class="grey-text text-lighten-4" href="#" target="_blank">Undergraduates</a> All rights reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">Undergraduates</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
    ...
    $("#formValidate1").validate({
		...
		name: {
		 ...
		 price: {
				...
				minlength: "Minimum item price is $ 0"
			},
	},
		errorElement : 'div',
        errorPlacement: function(error, element) {
